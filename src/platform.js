...
const DEFAULT_SAVE = {
  ...
  unlocked: [],
  settings: { sound: true, volume: 0.7, alwaysOnTop: true, scale: 1, opacity: 0.7, fill: 'blob', theme: 'void', themePinned: false, lowStim: false, overtime: true, newsSeen: 0, companion: true },
