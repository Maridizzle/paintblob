...
const DEFAULT_SAVE = {
  ...
  settings: { sound: true, volume: 0.7, alwaysOnTop: true, scale: 1, opacity: 0.7, fill: 'blob', theme: 'void', themePinned: false, dark: false, lowStim: false, overtime: true, newsSeen: 0, companion: true, adultPacksOk: false },
